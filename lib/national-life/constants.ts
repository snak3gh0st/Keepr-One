...
export const NATIONAL_LIFE_DEFAULT_BROWSER_PROVIDER = 'steel' as const
export const NATIONAL_LIFE_DEFAULT_BROWSER_SHARD_ID = 'national-life-shard-1'
export const NATIONAL_LIFE_DEFAULT_RECONNECT_BASE_DELAY_MS = 1_000
export const NATIONAL_LIFE_DEFAULT_RECONNECT_MAX_DELAY_MS = 30_000
